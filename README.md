...
This a simple template you can use to build a twitter bot using Python and an AWS Lambda function.
 
Why build a bot this way?
 
 1. It's quick and easy 
 2. You have full control over the bot's actions
 3. It only uses services from AWS free tier (see [limitations](#Limitations))
...
To build and use the bot, you'll need to:
 ...
 2. Create a [twitter app](https://developer.twitter.com/en/portal/projects-and-apps). Make sure that give it Read and Write permissions.
...
Once you are happy with the logic of your bot:
